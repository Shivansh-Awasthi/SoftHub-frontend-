...
const PcSoftwaresRedux = () => {
    // Redux hooks
    const dispatch = useDispatch();
    const { pcSoftware } = useSelector(state => state.apps);
    ...
    const { data = [], total: totalItems = 0, loading = false, error = null } = pcSoftware;
        ...
        <div className='container mx-auto p-2'>
            <div className='cover mb-6'>
                <h1 className='font-medium text-3xl mb-4'>
                    PC Softwares <span className='font-medium ml-2 text-[#8E8E8E]'>{totalItems}</span>
                </h1>
            </div>
...
export default PcSoftwaresRedux;
