...
const Ps3Redux = () => {
    ...
    const { ps3Apps } = useSelector(state => state.apps);
    ...
    const { data = [], total: totalItems = 0, loading = false, error = null } = ps3Apps;
        ...
        <div className='container mx-auto p-2'>
            <div className='cover mb-6'>
                <h1 className='font-medium text-3xl mb-4'>
                    PS3 ISO <span className='font-medium ml-2 text-[#8E8E8E]'>{totalItems}</span>
                </h1>
            </div>
